...
<nav class="navbar">
    ...
    <ul class="nav-list">
      <li><a href="FrmCadastrar.aspx">Usuario</a></li>
    ...
    <form id="form1" runat="server">
        <div class="kkkk"> 
            ...
            <fieldset>
                ...
                <a href="FrmLogin.aspx" class="a">Já tem um login?<br /> Clique aqui para logar</a>
